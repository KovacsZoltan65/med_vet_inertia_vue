        ...
        <div class="py-12">
            ...
            <div class="mb-3 p-4 bg-white shadow bg-body rounded w-75 ln-max-width mx-auto">
                <div class="
                    ...
                    <div class="ms-auto d-md-flex align-items-center">
                        <div class="">
                            <button type="button" class="btn btn-success" @click="newClient_init">
                                + New Client
                            </button>
                        </div>
                    </div>
            ...
            <div class="mb-3 p-4 bg-white shadow bg-body rounded w-75 ln-max-width mx-auto">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3 mb-md-0">
                        ...
                        <input @keyup.enter="getClients" type="text" class="form-control" id="filters.search"
                            placeholder="Search Name, Email, and Description" v-model="state.filters.search">
                    </div>

                    <div class="col-md-6">

                        <!-- Start Filter for Tags -->
                        <div class="mb-2 p-0" style=" border-bottom: 1px solid #d5d5d5;">
                            <input class="form-label mb-0" style="border: none;" type="text" 
                                placeholder="Filter for Tags" 
                                v-model="state.tag_filter_terms">
                        </div>
                        <ul class="list-group mb-5" v-if="props.tags.length > 0">
                            <li class="list-group-item" v-for="tag in tag_filter_options" 
                                :value="tag.id" 
                                :key="tag.id"
                ...
                <div class="mt-3 d-flex align-items-center justify-content-end">
                    <div class="">
                        <button class="btn btn-primary" @click="getClients">
                            Search
                        </button>
                    </div>
                </div>
            ...
            <div class="mb-3 bg-white shadow bg-body rounded w-75 ln-max-width mx-auto" style="overflow-x: scroll;">
                <div class="d-flex align-items-center justify-content-end p-2">
                    <button class="btn btn-outline-secondary bg-white" type="button" @click="openSettings">
                        Settings
                    </button>
                </div>
            ...
            <Modal id="modal_settings">
                ...
                <template #body>
                    <div v-for="(config, column) in state.columns" :key="column" class="d-flex align-items-center">
            ...
            <Modal id="modal_client_form">
                ...
                <template #body>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" id="name_first" placeholder="Acme Inc. or John"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" rows=5 cols=40 id="description" placeholder="Description"
                    ...
                    <div class="mb-5">
                        ...
                        <!-- Select Tags -->
                        <label for="select_tags" class="col-form-label form-check-label">
                            Select Tags
                        </label>
                        <select id="select_tags" name="select_tags" v-if="props.tags.length > 0" multiple
                            v-model="state.selected_tags"
                            class="form-select w-full bg-white border border-gray-200 px-3 py-2 rounded outline-none">
                            <option v-for="tag in props.tags" :value="tag.id" :key="tag.id">
                                {{ tag.name }}
                            </option>
                        </select>
                        <div v-else class="">
